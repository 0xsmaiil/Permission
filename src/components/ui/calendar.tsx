...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "group/calendar bg-background p-3 [--cell-radius:var(--radius-md)] [--cell-size:--spacing(10)]",
...
function CalendarDayButton({
  ...
  return (
    ...
    >
      {children}
      {modifiers.holiday && (
        <span className="mx-auto mt-0.5 block size-1.5 rounded-full bg-destructive opacity-100" />
      )}
      {modifiers.ramadan && (
        <span className="mx-auto mt-0.5 block size-1.5 rounded-full bg-amber-500 opacity-100" />
      )}
    </Button>
  )
}
